...
public class MyBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private com.boe.tvdevice.customView.MyBanner.BannerPagerAdapter adapter;
    ...
    public com.boe.tvdevice.customView.MyBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public com.boe.tvdevice.customView.MyBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public com.boe.tvdevice.customView.MyBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public com.boe.tvdevice.customView.MyBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public com.boe.tvdevice.customView.MyBanner setImages(List<?> imageUrls) {
    ...
    public com.boe.tvdevice.customView.MyBanner start() {
        setBannerStyleUI();
    ...
    private void setData() {
        currentItem = 1;
        if (adapter == null) {
            adapter = new com.boe.tvdevice.customView.MyBanner.BannerPagerAdapter();
    ...
    public void setCurrentItem(int pageNum){
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public com.boe.tvdevice.customView.MyBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public com.boe.tvdevice.customView.MyBanner setOnBannerListener(OnBannerListener listener) {
